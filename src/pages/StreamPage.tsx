...
const StreamPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"upcoming" | "released">(
    "upcoming",
  );
  ...
  const handleScheduleGroup = async (groupId: string) => {
    ...
    try {
      ...
      const releasedGroup = await streamService.releaseGroup(
        groupId,
        hederaAccountId,
      );
            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-12 shadow-xl max-w-md">
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Automate asset transfers with precise timing and logic. Stream
                  wealth to the right people, exactly when it matters.
                </p>
                <button
                  onClick={() => open()}
            ...
            <>
              ...
              <div className="mb-8">
                {loading ? (
                  ...
                  <StreamTable
                    data={
                      activeTab === "upcoming" ? upcomingGroups : releasedGroups
                    }
